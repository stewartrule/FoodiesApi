...
final class Voucher: Model, Content {
    ...
    @Timestamp(key: "valid_from", on: .none) var validFrom: Date?

    @Timestamp(key: "valid_until", on: .none) var validUntil: Date?

    @Field(key: "discount_percentage") var discountPercentage: Int
    ...
    @Timestamp(key: "redeemed_at", on: .none) var deliveredAt: Date?

    @OptionalParent(key: "order_id") var order: Order?
